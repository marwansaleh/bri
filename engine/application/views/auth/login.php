    ...
    <form method="post" id="login-form" class="login-form" action="<?php echo $submit; ?>" >        
        <div class="login-wrap">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" name="username" placeholder="Username /email" value="<?php echo isset($remember) ? $remember->username:''; ?>" autofocus>
            </div>
            <div class="input-group">
                <span class="input-group-addon"><i class="icon_key_alt"></i></span>
                <input type="password" class="form-control" name="password" value="<?php echo isset($remember) ? $remember->password:''; ?>" placeholder="Password">
            </div>
